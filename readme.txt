...
== Changelog ==
= Version 3.3.3 =
>[Enhanced code security](https://www.bbp.design/bbpress-login-register-links-on-forum-topic-pages-3-3-3-released-enhanced-code-security/)

= Version 3.3.1 =
>[Fixed bbpress sidebar](https://www.bbp.design/fixed-a-bug-in-certain-cases-when-user-does-not-use-the-bbpress-sidebar-apache2-generates-a-php-warning-bbpress-login-pro-3-8-0-and-bbpress-login-free-3-3-1-released/)

= Version 3.2.7 =
new "bbPress Login Notification Settings" panel and menu

= Version 3.2.5 =
>[Add a dynamic input field to the register form to stop a few kinds of spam-bot, description can be found at here](https://tooltips.org/wordpress-tooltips-free-8-6-3-released/)
