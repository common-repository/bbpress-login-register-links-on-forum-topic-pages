				...
				if ((is_array($bbpress_sidebars_array_keys)) && count($bbpress_sidebars_array_keys) > 0)
				{
					...
					if (!(empty($bbpress_login_sidebars_key)))
					{
						...
						if (isset($sidebars_widgets[$bbpress_login_sidebars_key]))
						{
							...
							// before 3.3.1 $sidebars_widgets[$bbpress_login_sidebars_key] = $sidebars_widgets['bbpress-sidebar'];
							// before 3.3.1 return $sidebars_widgets;
							//3.3.1
							if (isset($sidebars_widgets['bbpress-sidebar']))
							{
